                ...
                <div class="header-right">
                    ...
                    <nav class="main-nav ls-20">
                        <ul class="menu sf-arrows">
                            ...
                            <li>
                                <a href="blogs.php" style="color: Red;">Blog</a>
                            </li>
                            <li>
                        ...
                        <div class="grid row">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    $image_path = !empty($row['main_image']) ? "./admin/uploads/photos/{$row['main_image']}" : "https://mailrelay.com/wp-content/uploads/2018/03/que-es-un-blog-1.png";
                                    ...
                                    <div class='grid-item col-sm-12 col-lg-4'>
                                        <div class='post-box'>
                                            ...
                                            <div class='box-content'>
                                                <h5 class='box-title'><a href='fullblog.php?id={$row['id']}'>" . substr(strip_tags($row['title']), 0, 20) . "...</a></h5>
                                                <p class='post-desc' style='text-align: justify;'>" . substr(strip_tags($row['main_content']), 0, 100) . "...</p>
                                                <a href='fullblog.php?id={$row['id']}'><button class='bg-primary mt-2 p-2' style='border-width:0px; color:white; border-radius:2px'>Read More</button></a>
                                            </div>
                                        </div>
                                    </div>";
                                }
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-6 col-6">
                            <div class="title_box">
                                ...
                                <ul class="title_list">
                                    ...
                                    <li><a href="./blogs.php" class="title_link">Blogs
                                        </a></li>
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav mt-5">
                <ul class="mobile-menu">
                    ...
                    <li>
                        <a href="blogs.php" class="sf-with-ul">Blog</a>
